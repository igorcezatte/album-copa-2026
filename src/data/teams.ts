...
export const FWC_SECTION: SpecialSection = {
  ...
  stickers: [
    ...
    { number: '4',  label: 'We Are FIFA',              type: 'special' },
    { number: '5',  label: 'Bola Oficial – Trionda',   type: 'special' },
    { number: '6',  label: 'Países Sede – Canadá',     type: 'special' },
    { number: '7',  label: 'FIFA World Cup 2026 – CAN MEX USA', type: 'special' },
    { number: '8',  label: 'Países Sede – EUA',        type: 'special' },
    { number: '9',  label: 'Itália 1934',              type: 'special' },
    { number: '10', label: 'Uruguai 1950',             type: 'special' },
    { number: '11', label: 'Alemanha FR 1954',         type: 'special' },
    { number: '12', label: 'Brasil 1962',              type: 'special' },
    { number: '13', label: 'Alemanha FR 1974',         type: 'special' },
    { number: '14', label: 'Argentina 1986',           type: 'special' },
    { number: '15', label: 'Brasil 1994',              type: 'special' },
    { number: '16', label: 'Brasil 2002',              type: 'special' },
    { number: '17', label: 'Itália 2006',              type: 'special' },
    { number: '18', label: 'Alemanha 2014',            type: 'special' },
    { number: '19', label: 'Argentina 2022',           type: 'special' },
  ],
}
